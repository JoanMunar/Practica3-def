...
public class RolDaoImpl implements RolDao {
    ...
    public Rol obtenirRol(String rol) throws SQLException {
        /*Inici Sql*/
        String sql = "SELECT roles.role_name,user_roles.user_name FROM users,roles,user_roles WHERE roles.role_name=? AND roles.role_name=user_roles.role_name AND users.user_name=user_roles.user_name";
